...
def get_recipe_tracking_config(
    ...
    if is_in_databricks_runtime():
        ...
        mlflow_metadata_base_path = (
            pathlib.Path(recipe_root_path) / "metadata" / "mlflow"
        )
    ...
    config_obj_kwargs = {
        ...
        "artifact_location": tracking_config.get(
...
def apply_recipe_tracking_config(tracking_config: TrackingConfig):
    ...
    fluent_set_experiment(
        experiment_id=tracking_config.experiment_id,
