"""
.. opengate-anomaly-detection-recipe:

The MLflow Anomaly Recipe is an MLflow Recipe for developing binary Anomaly
models. Multiclass classifiers are currently not supported.
The Anomaly recipe is designed for developing models using scikit-learn and
...
class AnomalyRecipe(BaseRecipe):
    """
